...
function MakeModir(props) {
    ...
    const [ostadRah, setOstadRah] = useState("");
    ...
    const handleOstad = async (event) => {
        ...
        let data = {
            ...
            fieldOfStudy: field,
            ostad: ostadRah,
            passcoures: passedCourses.split(',')
        }

        // data.passcoures = passedCourses.split(',');
    ...
    const handleLevelChange = event => {
        setOstadRah(event.target.value);
    };
    ...
    return (<div>
        <div className="container">
            <h1>ثبت / تغییر اطلاعات دانشجو جدید</h1>
            <div className="row">
                <form className="col-xl-9" onSubmit={handleOstad}>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <label htmlFor="level" className="form-label">استاد راهنما</label>
                            <input type="text" className="form-control" id="level" placeholder="Ostad Rahnama" value={ostadRah}
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <label htmlFor="id_number" className="form-label">دروس پاس کرده</label>
                            <input type="text" className="form-control" id="id_number" placeholder="Passed Courses"
                                   value={passedCourses} onChange={handlePassedChange}/>
                        </div>
                    </div>
